...
#define JNIREG_CLASS "com/lxzh123/classloader/Helper"   //指定要注册的类
...
//    jclass DexFileClass = env->FindClass("dalvik/system/DexFile");
    ...
    LOGD("[+] inject_dex 2");
    jmethodID getDir = env->GetMethodID(ApplicationClass, "getDir", "(Ljava/lang/String;I)Ljava/io/File;");
    ...
    jfieldID pathListId = env->GetFieldID(BaseDexClassLoaderClass, "pathList", "Ldalvik/system/DexPathList;");
    ...
    jobjectArray dexElement1 = static_cast<jobjectArray>(env->GetObjectField(pathList1, dexElementsId));
    ...
    jobject dexClassLoader = env->NewObject(DexClassLoaderClass, DexClassLoaderInit, dexPath, optDir, dexPath, classLoader);
    ...
    jobjectArray dexElement2 = static_cast<jobjectArray>(env->GetObjectField(pathList2, dexElementsId));
